...
-- Botão de abrir/fechar (sempre à esquerda, mais para baixo)
...
-- Barra de título com gradiente animado
...
toggleButton.MouseButton1Click:Connect(function()
    ...
    toggleButton.Text = guiOpen and "Fechar GUI" or "Abrir GUI"
end)
